...
export default function InternshipsPage({ onBack }: InternshipsPageProps) {
  const containerRef = useRef<HTMLDivElement>(null);
  const [logs, setLogs] = useState<string[]>([
    '> INFOSYS SPRINGBOARD ARCHIVE DECRYPTED...',
        ...
        <div className="max-w-6xl mx-auto px-6 pt-32 w-full relative z-10">
          ...
          <header className="mb-20 flex flex-col items-center text-center relative z-10">
            ...
            <p className="font-sans text-sm sm:text-base tracking-wide leading-relaxed max-w-2xl text-neutral-700 mb-8 px-4 font-normal">
              Building AI-powered analytics systems through APIs, dashboards, and data intelligence.
            </p>
              ...
              {keyFeatures.map((feat, idx) => (
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="font-sans text-xs text-neutral-700 leading-relaxed mt-2">{feat.desc}</p>
                  </div>
          ...
          <section className="w-full max-w-4xl mx-auto mb-20 text-left relative z-10">
            <div className="inline-flex items-center gap-3 mb-8 opacity-45">
              <div className="h-[1.5px] w-8 bg-[#00CC52]" />
            ...
            <div className="relative pl-6 sm:pl-8 border-l border-black/10 flex flex-col gap-8">
              {timeline.map((step, idx) => (
                ...
                >
                  ...
                  <p className="font-sans text-sm text-neutral-700 leading-relaxed font-light">
                    {step.desc}
                  </p>
                </motion.div>
              ))}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {challenges.map((chal, idx) => (
                ...
                >
                  ...
                  <p className="font-sans text-xs text-neutral-700 leading-relaxed mt-2 border-t border-black/5 pt-3">
          ...
          <section className="w-full max-w-5xl mx-auto mb-20 relative z-10">
          ...
          {/* SECTION 9: FINAL CONCLUSION SECTION */}
          <section className="w-full max-w-5xl mx-auto mb-20 text-left relative z-10">
            <div className="relative border border-black/10 rounded-sm p-8 sm:p-12 overflow-hidden bg-white/80 shadow-[10px_10px_0px_rgba(168,211,200,0.12)] hover:border-black transition-all duration-500">
              ...
              <h3 className="font-display font-black text-2xl uppercase tracking-tighter text-black mb-4">
                FINAL ARCHIVE RESOLUTION
              </h3>
              <p className="font-sans text-[14.5px] leading-relaxed font-light text-neutral-700">
                The Infosys Springboard Internship provided a comprehensive corporate engineering pipeline, successfully validating the integration of real-world API data with responsive front-end visualization models. The result is a fully functional creator-centric intelligence ecosystem.
              </p>
            </div>
          </section>
