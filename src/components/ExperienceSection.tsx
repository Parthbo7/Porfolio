...
const CARDS: CardConfig[] = [
  ...
  },
  {
    ...
    year: '2026',
    title: 'VISOTECH 2026',
    subtitle: 'Building futuristic digital systems and creative technology experiences.',
    description:
      'Worked on experimental UI systems, futuristic interfaces, and innovative digital visual workflows.',
    tags: ['UI Systems', 'Visual Tech', 'Digital Innovation', 'Creative Development'],
    side: 'right',
  ...
  },
  {
    ...
    subtitle: 'Academic excellence in engineering mechanics and analytical systems.',
    description:
      'Achieved top academic performance through analytical problem-solving and engineering precision.',
