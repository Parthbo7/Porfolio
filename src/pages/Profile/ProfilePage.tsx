        ...
        <AnimatePresence mode="wait">
          ...
          {activeFilter === 'identity' && (
            <motion.div 
              ...
              className="w-full max-w-4xl px-6 py-12 text-left"
            >
              <div className="border border-[#00FF66] bg-black text-[#00FF66] p-6 rounded-sm font-mono text-[11px] leading-relaxed shadow-[0_0_20px_rgba(0,255,102,0.1)] relative overflow-hidden max-w-xl mx-auto">
                <div className="absolute top-0 right-0 font-mono text-[7px] text-emerald-500/40 uppercase tracking-[0.25em] px-2.5 py-1">
                  SECURE_GATEWAY
                </div>
